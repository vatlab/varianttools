...
class TestUpdate(ProcessTestCase):
    def testAddField(self):
        ...
        self.assertOutput('vtools select variant "mut_type is not null" -c', '78\n')
        ...
        self.assertOutput('vtools select variant "mut_type is not null" -c', '81\n')
    ...
    def testUpdate(self):
        ...
        self.assertOutput('vtools select variant "mut_type_dbSNP is not null" -c', '175\n')
