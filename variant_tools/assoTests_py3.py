...
def my_error_handler(*args, **kwargs) -> "void" :
  return _assoTests.my_error_handler(*args, **kwargs)
...
vectors.iterator = new_instancemethod(_assoTests.vectors_iterator,None,vectors)
vectors.__nonzero__ = new_instancemethod(_assoTests.vectors___nonzero__,None,vectors)
vectors.__bool__ = new_instancemethod(_assoTests.vectors___bool__,None,vectors)
...
vectors.__getslice__ = new_instancemethod(_assoTests.vectors___getslice__,None,vectors)
vectors.__setslice__ = new_instancemethod(_assoTests.vectors___setslice__,None,vectors)
vectors.__delslice__ = new_instancemethod(_assoTests.vectors___delslice__,None,vectors)
vectors.__delitem__ = new_instancemethod(_assoTests.vectors___delitem__,None,vectors)
vectors.__getitem__ = new_instancemethod(_assoTests.vectors___getitem__,None,vectors)
vectors.__setitem__ = new_instancemethod(_assoTests.vectors___setitem__,None,vectors)
...
vectors.get_allocator = new_instancemethod(_assoTests.vectors_get_allocator,None,vectors)
...
vectors.pop_back = new_instancemethod(_assoTests.vectors_pop_back,None,vectors)
vectors.erase = new_instancemethod(_assoTests.vectors_erase,None,vectors)
vectors.push_back = new_instancemethod(_assoTests.vectors_push_back,None,vectors)
...
vectors.capacity = new_instancemethod(_assoTests.vectors_capacity,None,vectors)
...
def Mann_Whitneyu(*args, **kwargs) -> "double" :
  return _assoTests.Mann_Whitneyu(*args, **kwargs)
Mann_Whitneyu = _assoTests.Mann_Whitneyu

def chisq2X2stat(*args, **kwargs) -> "double" :
  return _assoTests.chisq2X2stat(*args, **kwargs)
chisq2X2stat = _assoTests.chisq2X2stat

def dnhyper(*args, **kwargs) -> "std::vector< double,std::allocator< double > >" :
  return _assoTests.dnhyper(*args, **kwargs)
dnhyper = _assoTests.dnhyper

def mnhyper(*args, **kwargs) -> "double" :
  return _assoTests.mnhyper(*args, **kwargs)
mnhyper = _assoTests.mnhyper

def pnhyper(*args, **kwargs) -> "double" :
  return _assoTests.pnhyper(*args, **kwargs)
...
def calculateInbreedingCoef(*args, **kwargs) -> "double" :
  return _assoTests.calculateInbreedingCoef(*args, **kwargs)
...
RunningStat.Clear = new_instancemethod(_assoTests.RunningStat_Clear,None,RunningStat)
RunningStat.Push = new_instancemethod(_assoTests.RunningStat_Push,None,RunningStat)
RunningStat.NumDataValues = new_instancemethod(_assoTests.RunningStat_NumDataValues,None,RunningStat)
RunningStat.Mean = new_instancemethod(_assoTests.RunningStat_Mean,None,RunningStat)
RunningStat.Variance = new_instancemethod(_assoTests.RunningStat_Variance,None,RunningStat)
RunningStat.StandardDeviation = new_instancemethod(_assoTests.RunningStat_StandardDeviation,None,RunningStat)
...
def pyAssoDataObj(*args, **kwargs) -> "PyObject *" :
  return _assoTests.pyAssoDataObj(*args, **kwargs)
...
LMData.replaceColumn = new_instancemethod(_assoTests.LMData_replaceColumn,None,LMData)
...
LogisticM.niterations = new_instancemethod(_assoTests.LogisticM_niterations,None,LogisticM)
...
AssoData.setGenotypeId = new_instancemethod(_assoTests.AssoData_setGenotypeId,None,AssoData)
AssoData.setPhenotype = new_instancemethod(_assoTests.AssoData_setPhenotype,None,AssoData)
AssoData.isYBinary = new_instancemethod(_assoTests.AssoData_isYBinary,None,AssoData)
AssoData.countCaseCtrl = new_instancemethod(_assoTests.AssoData_countCaseCtrl,None,AssoData)
AssoData.phenotype = new_instancemethod(_assoTests.AssoData_phenotype,None,AssoData)
AssoData.getPhenotype = new_instancemethod(_assoTests.AssoData_getPhenotype,None,AssoData)
AssoData.genotype = new_instancemethod(_assoTests.AssoData_genotype,None,AssoData)
AssoData.getGenotype = new_instancemethod(_assoTests.AssoData_getGenotype,None,AssoData)
AssoData.genotype_id = new_instancemethod(_assoTests.AssoData_genotype_id,None,AssoData)
AssoData.raw_genotype = new_instancemethod(_assoTests.AssoData_raw_genotype,None,AssoData)
AssoData.getRawGenotype = new_instancemethod(_assoTests.AssoData_getRawGenotype,None,AssoData)
AssoData.covariates = new_instancemethod(_assoTests.AssoData_covariates,None,AssoData)
AssoData.getCovariates = new_instancemethod(_assoTests.AssoData_getCovariates,None,AssoData)
AssoData.modeldata = new_instancemethod(_assoTests.AssoData_modeldata,None,AssoData)
AssoData.samplecounts = new_instancemethod(_assoTests.AssoData_samplecounts,None,AssoData)
AssoData.locicounts = new_instancemethod(_assoTests.AssoData_locicounts,None,AssoData)
AssoData.allelecounts = new_instancemethod(_assoTests.AssoData_allelecounts,None,AssoData)
...
AssoData.permuteAllX = new_instancemethod(_assoTests.AssoData_permuteAllX,None,AssoData)
...
AssoData.getDoubleVar = new_instancemethod(_assoTests.AssoData_getDoubleVar,None,AssoData)
AssoData.getIntVar = new_instancemethod(_assoTests.AssoData_getIntVar,None,AssoData)
AssoData.getArrayVar = new_instancemethod(_assoTests.AssoData_getArrayVar,None,AssoData)
AssoData.getIntArrayVar = new_instancemethod(_assoTests.AssoData_getIntArrayVar,None,AssoData)
AssoData.getMatrixVar = new_instancemethod(_assoTests.AssoData_getMatrixVar,None,AssoData)
AssoData.getStringVar = new_instancemethod(_assoTests.AssoData_getStringVar,None,AssoData)
...
class BrowningWeight(BaseAction):
    ...
    def __init__(self, *args, **kwargs): 
        _assoTests.BrowningWeight_swiginit(self,_assoTests.new_BrowningWeight(*args, **kwargs))
...
class FillGMissing(BaseAction):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def __init__(self, method : 'std::string'="maf"): 
        _assoTests.FillGMissing_swiginit(self,_assoTests.new_FillGMissing(method))
...
class WeightByInfo(BaseAction):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args, **kwargs): 
        _assoTests.WeightByInfo_swiginit(self,_assoTests.new_WeightByInfo(*args, **kwargs))
...
class SetSites(BaseAction):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def __init__(self, upper : 'double'=1.0, lower : 'double'=0.0, use_mac : 'bool'=False): 
        _assoTests.SetSites_swiginit(self,_assoTests.new_SetSites(upper, lower, use_mac))
...
class MultipleRegression(BaseAction):
    ...
    def __init__(self, iSE : 'bool'=True, method : 'unsigned int'=0): 
        _assoTests.MultipleRegression_swiginit(self,_assoTests.new_MultipleRegression(iSE, method))
...
class Fisher2X2(BaseAction):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args, **kwargs): 
        _assoTests.Fisher2X2_swiginit(self,_assoTests.new_Fisher2X2(*args, **kwargs))
...
class MannWhitneyu(BaseAction):
    ...
    def __init__(self, alternative : 'unsigned int'=1, store : 'bool'=False): 
        _assoTests.MannWhitneyu_swiginit(self,_assoTests.new_MannWhitneyu(alternative, store))
...
class WSSPvalue(BaseAction):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args, **kwargs): 
        _assoTests.WSSPvalue_swiginit(self,_assoTests.new_WSSPvalue(*args, **kwargs))
...
class FindGenotypePattern(BaseAction):
    ...
    __repr__ = _swig_repr
    def __init__(self): 
        _assoTests.FindGenotypePattern_swiginit(self,_assoTests.new_FindGenotypePattern())
...
class KBACtest(BaseAction):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def __init__(self, alternative : 'unsigned int'=1, weightOnly : 'bool'=False): 
        _assoTests.KBACtest_swiginit(self,_assoTests.new_KBACtest(alternative, weightOnly))
...
class RBTtest(BaseAction):
    ...
    __repr__ = _swig_repr
    def __init__(self, alternative : 'unsigned int'=1, weightOnly : 'bool'=False): 
        _assoTests.RBTtest_swiginit(self,_assoTests.new_RBTtest(alternative, weightOnly))
...
class FindVariantPattern(BaseAction):
    ...
    __repr__ = _swig_repr
    def __init__(self): 
        _assoTests.FindVariantPattern_swiginit(self,_assoTests.new_FindVariantPattern())
...
class VTFisher(BaseAction):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args, **kwargs): 
        _assoTests.VTFisher_swiginit(self,_assoTests.new_VTFisher(*args, **kwargs))
...
class CalphaTest(BaseAction):
    ...
    def __init__(self, permutation : 'bool'=False): 
        _assoTests.CalphaTest_swiginit(self,_assoTests.new_CalphaTest(permutation))
...
class RareCoverTest(BaseAction):
    ...
    def __init__(self, difQ : 'double'=0.5): 
        _assoTests.RareCoverTest_swiginit(self,_assoTests.new_RareCoverTest(difQ))
...
BasePermutator.getP = new_instancemethod(_assoTests.BasePermutator_getP,None,BasePermutator)
...
class PyAction(BaseAction):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args, **kwargs): 
        _assoTests.PyAction_swiginit(self,_assoTests.new_PyAction(*args, **kwargs))
...
class FixedPermutator(BasePermutator):
    ...
    def __init__(self, *args): 
        _assoTests.FixedPermutator_swiginit(self,_assoTests.new_FixedPermutator(*args))
...
class VariablePermutator(BasePermutator):
    ...
    def __init__(self, *args): 
        _assoTests.VariablePermutator_swiginit(self,_assoTests.new_VariablePermutator(*args))
...
class StackingPermutator(BasePermutator):
    ...
    def __init__(self, *args): 
        _assoTests.StackingPermutator_swiginit(self,_assoTests.new_StackingPermutator(*args))
...
class WeightedGenotypeTester(BasePermutator):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args, **kwargs): 
        _assoTests.WeightedGenotypeTester_swiginit(self,_assoTests.new_WeightedGenotypeTester(*args, **kwargs))
...
class OptimalWeightTester(BasePermutator):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args, **kwargs): 
        _assoTests.OptimalWeightTester_swiginit(self,_assoTests.new_OptimalWeightTester(*args, **kwargs))
...
def gsl_cdf_gaussian_P(*args, **kwargs) -> "double" :
  return _assoTests.gsl_cdf_gaussian_P(*args, **kwargs)
gsl_cdf_gaussian_P = _assoTests.gsl_cdf_gaussian_P

def gsl_cdf_gaussian_Q(*args, **kwargs) -> "double" :
  return _assoTests.gsl_cdf_gaussian_Q(*args, **kwargs)
gsl_cdf_gaussian_Q = _assoTests.gsl_cdf_gaussian_Q

def gsl_cdf_gaussian_Pinv(*args, **kwargs) -> "double" :
  return _assoTests.gsl_cdf_gaussian_Pinv(*args, **kwargs)
gsl_cdf_gaussian_Pinv = _assoTests.gsl_cdf_gaussian_Pinv

def gsl_cdf_gaussian_Qinv(*args, **kwargs) -> "double" :
  return _assoTests.gsl_cdf_gaussian_Qinv(*args, **kwargs)
gsl_cdf_gaussian_Qinv = _assoTests.gsl_cdf_gaussian_Qinv

def gsl_cdf_ugaussian_P(*args, **kwargs) -> "double" :
  return _assoTests.gsl_cdf_ugaussian_P(*args, **kwargs)
gsl_cdf_ugaussian_P = _assoTests.gsl_cdf_ugaussian_P

def gsl_cdf_ugaussian_Q(*args, **kwargs) -> "double" :
  return _assoTests.gsl_cdf_ugaussian_Q(*args, **kwargs)
gsl_cdf_ugaussian_Q = _assoTests.gsl_cdf_ugaussian_Q

def gsl_cdf_ugaussian_Pinv(*args, **kwargs) -> "double" :
  return _assoTests.gsl_cdf_ugaussian_Pinv(*args, **kwargs)
gsl_cdf_ugaussian_Pinv = _assoTests.gsl_cdf_ugaussian_Pinv

def gsl_cdf_ugaussian_Qinv(*args, **kwargs) -> "double" :
  return _assoTests.gsl_cdf_ugaussian_Qinv(*args, **kwargs)
